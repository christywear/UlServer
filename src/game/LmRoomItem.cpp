...
const LmItem& LmRoomItem::Item() const
{
    return item_;
}

const LmPosition& LmRoomItem::Position() const
{
    return pos_;
}

time_t LmRoomItem::TimeToDie() const
{
    return timetodie_;
}

LmItem& LmRoomItem::Item()
{
    return item_;
}

LmPosition& LmRoomItem::Position()
{
    return pos_;
}

void LmRoomItem::SetLifetime(int lifetime)
{
