...
#include "../../../include/Server/Gamed/GsGameThread.h"
#include "../../../include/Server/Gamed/GsNetworkInput.h"
#include "../../../include/Server/Gamed/GsNetworkOutput.h"
#include "../../../include/Server/Gamed/GsForwardThread.h"
#include "../../../include/Server/Gamed/GsPositionThread.h"
#include "../../../include/Server/Gamed/GsLevelSet.h"
#include "../../../include/Server/Gamed/GsPlayerThreadSet.h"
#include "../../../include/Core/PTh.h"
#include "../../../include/DB/LmGuildDBC.h"
...
int GsMain::MaxPlayers() const
{
    return max_players_;
}

const LmGlobalDB* GsMain::GlobalDB() const
{
    return globaldbc_;
}

const LmServerDBC* GsMain::ServerDBC() const
{
    return serverdbc_;
}

LmPlayerNameMap* GsMain::PlayerNameMap() const
{
    return pnames_;
}

GsLevelSet* GsMain::LevelSet() const
{
    return lset_;
}

GsPlayerSet* GsMain::PlayerSet() const
{
    return pset_;
}

LmThreadPool* GsMain::ThreadPool() const
{
    return tpool_;
}

GsOutputDispatch* GsMain::OutputDispatch() const
{
    return outp_;
}

GsInputDispatch* GsMain::InputDispatch() const
{
    return inp_;
}

LmConnectionSet* GsMain::ConnectionSet() const
{
    return cset_;
}

LmMesgBufPool* GsMain::BufferPool() const
{
    return mpool_;
}

LmSocket* GsMain::SocketTCP() const
{
    return tsock_;
}

LmSocket* GsMain::SocketUDP() const
{
    return usock_;
}

int GsMain::ServerPort() const
{
    return portnum_;
}

int GsMain::NextPort() const
{
    return next_port_;
}

pid_t GsMain::ServerPid() const
{
    return pid_;
}

pid_t GsMain::ParentPid() const
{
    return ppid_;
}

time_t GsMain::LastAlarm(void) const
{
    return last_alrm_;
}

GsPlayerThreadSet* GsMain::PlayerThreadSet() const
{
    return ptset_;
}

LmGuildDBC* GsMain::GuildDBC() const
{
    return gdbc_;
}

LmItemDBC* GsMain::ItemDBC() const
{
    return idbc_;
}

LmPlayerDBC* GsMain::PlayerDBC() const
{
    return pdbc_;
}

LmBillingDBC* GsMain::BillingDBC() const
{
    return bdbc_;
}

int GsMain::Uptime() const
{
    return LmUtil::TimeSince(start_time_);
}

char* GsMain::HostIP() const
{
    return (char*)host_ip_;
}

char* GsMain::NextIP() const
{
    return (char*)next_ip_;
}

unsigned long GsMain::HostIPAddress()
{
    return host_ip_addr_;
}

bool GsMain::Closed() const
{
    return closed_;
}

int GsMain::NumLogins() const
{
    return num_logins_;
}

void GsMain::SetNumLogins(int num_logins)
{
