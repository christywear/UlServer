...
#include "../../../include/Server/Gamed/resource.h"
...
const LmPlayerDB& GsPlayer::DB() const
{
    return db_;
}

LmConnection* GsPlayer::Connection() const
{
    return conn_;
}

LmConnection* GsPlayer::LevelConnection() const
{
    return lsconn_;
}

const LmSockAddrInet& GsPlayer::LevelAddress() const
{
    return level_addr_;
}

const LmSockAddrInet& GsPlayer::ClientAddress() const
{
    return client_addr_;
}

const LmSockAddrInet& GsPlayer::UpdateAddress() const
{
    return update_addr_;
}

const LmPeerUpdate& GsPlayer::PlayerUpdate() const
{
    return update_;
}

bool GsPlayer::NewlyNeedsAnnounce()
{
    return newly_announce;
}

void GsPlayer::SetNewlyNeedsAnnounce(bool announce)
{
    newly_announce = announce;
}

time_t GsPlayer::LastUpdateTime() const
{
    return last_update_;
}

const LmAvatar& GsPlayer::Avatar() const
{
    return avatar_;
}

void GsPlayer::SetLog(LmLog* log)
{
    log_ = log;
}

int GsPlayer::NumKills() const
{
    return num_kills_;
}

int GsPlayer::NumRecentDeaths() const
{
    return num_recent_deaths_;
}

int GsPlayer::NumOrbitKills() const
{
    return num_orbit_kills_;
}

void GsPlayer::SetNumRecentDeaths(int value)
{
    num_recent_deaths_ = value;
}

void GsPlayer::SetNumOrbitKills(int value)
{
    num_orbit_kills_ = value;
}

int GsPlayer::NumDeaths() const
{
    return num_deaths_;
}

bool GsPlayer::HasFired() const
{
    return has_fired_;
}

int GsPlayer::PPEvoking() const
{
    return pp_evoking_;
}

void GsPlayer::SetPPEvoking(int value)
{
    pp_evoking_ = value;
}

int GsPlayer::PPSkill() const
{
    return pp_skill_;
}

void GsPlayer::SetPPSkill(int value)
{
    pp_skill_ = value;
}

bool GsPlayer::Firewall() const
{
    return firewall_;
}

bool GsPlayer::TCPOnly() const
{
    return tcp_only_;
}

bool GsPlayer::BeenHit() const
{
    return been_hit_;
}

bool GsPlayer::DreamsoulDecreased() const
{
    return ds_decreased_;
}

int GsPlayer::NumUpdates() const
{
    return num_updates_;
}

//const char* GsPlayer::Description() const
//{
//  return desc_;
//}
