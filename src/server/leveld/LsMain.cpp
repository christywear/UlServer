...
#include "../../../include/Server/Leveld/LsRoomThread.h"
#include "../../../include/Server/Leveld/LsNetworkInput.h"
...
const LmGlobalDB* LsMain::GlobalDB() const
{
    return globaldbc_;
}

const LmServerDBC* LsMain::ServerDBC() const
{
    return serverdbc_;
}

const LmLevelDBC* LsMain::LevelDBC() const
{
    return leveldbc_;
}

LsLevelState* LsMain::LevelState() const
{
    return levelstate_;
}

LsPlayerSet* LsMain::PlayerSet() const
{
    return pset_;
}

LmThreadPool* LsMain::ThreadPool() const
{
    return tpool_;
}

LsOutputDispatch* LsMain::OutputDispatch() const
{
    return outp_;
}

LsInputDispatch* LsMain::InputDispatch() const
{
    return inp_;
}

LmConnectionSet* LsMain::ConnectionSet() const
{
    return cset_;
}

LmMesgBufPool* LsMain::BufferPool() const
{
    return mpool_;
}

LmSocket* LsMain::SocketUDP() const
{
    return usock_;
}

LmSocket* LsMain::SocketTCP() const
{
    return tsock_;
}

pid_t LsMain::ServerPid() const
{
    return pid_;
}

pid_t LsMain::ParentPid() const
{
    return ppid_;
}

int LsMain::ServerPort() const
{
    return port_num_;
}

LmItemDBC* LsMain::ItemDBC() const
{
    return idbc_;
}

lyra_id_t LsMain::LevelNum() const
{
    return level_num_;
}

int LsMain::Uptime() const
{
    return LmUtil::TimeSince(start_time_);
}

LsCodexText* LsMain::CodexText() const
{
    return ctext_;
}