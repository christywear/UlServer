...
const char* MsMain::HostAddrString() const
{
    return hostaddrstr_;
}

const LmGlobalDB* MsMain::GlobalDB() const
{
    return globaldb_;
}

const LmServerDBC* MsMain::ServerDB() const
{
    return serverdbc_;
}

MsServerInfo* MsMain::ServerInfo() const
{
    return sinfo_;
}

pid_t MsMain::ServerPid() const
{
    return pid_;
}

bool MsMain::Restart() const
{
    return restart_;
}