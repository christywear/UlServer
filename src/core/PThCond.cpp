...
#ifdef __GNUC__
#pragma implementation "PThCond.h"
#endif

#include "../../include/Core/PThCond.h"
...
int PThCond::Wait(PThMutex* mutex)
{
#ifdef WIN32
...
int PThCond::TimedWait(PThMutex* mutex, const struct timespec* abstime)
{
