...
#include "../../../include/Protocol/RMsg/RMsg_ItemHdrDrop.h"
...
#ifndef USE_DEBUG
void RMsg_ItemHdrDrop::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int RMsg_ItemHdrDrop::NumItems() const
{
    return num_items_;
}

const LmItemHdr& RMsg_ItemHdrDrop::ItemHeader(int num) const
{
    return data_.itemhdrs[num].itemhdr;
}

const LmPosition& RMsg_ItemHdrDrop::Position(int num) const
{
    return data_.itemhdrs[num].pos;
}

void RMsg_ItemHdrDrop::SetItemHeader(int num, const LmItemHdr& itemhdr,
...
void RMsg_ItemHdrDrop::SetItem(int num, const LmItem& item, const LmPosition& pos)
{
