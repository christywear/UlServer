...
#ifndef USE_DEBUG
void RMsg_Update::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t RMsg_Update::PlayerID() const
{
    return data_.playerid;
}

const LmPeerUpdate& RMsg_Update::PeerUpdate() const
{
    return data_.update;
}

LmPeerUpdate& RMsg_Update::PeerUpdate()
{
    return data_.update;
}

void RMsg_Update::SetPlayerID(lyra_id_t playerid)
{
    data_.playerid = playerid;
}

void RMsg_Update::SetPeerUpdate(const LmPeerUpdate& update)
{
    data_.update = update;
}