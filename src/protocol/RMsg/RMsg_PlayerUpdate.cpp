...
#ifndef USE_DEBUG
void RMsg_PeerUpdate::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

const LmPeerUpdate& RMsg_PeerUpdate::Update() const
{
    return data_.update;
}

void RMsg_PeerUpdate::SetUpdate(const LmPeerUpdate& update)
{
    data_.update = update;
}

#ifndef USE_DEBUG
void RMsg_PlayerUpdate::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t RMsg_PlayerUpdate::PlayerID() const
{
    return data_.playerid;
}

int RMsg_PlayerUpdate::NumPlayers() const
{
    return num_players_;
}

const LmPeerUpdate& RMsg_PlayerUpdate::PeerUpdate(int num) const
{
    return data_.players[num];
}

void RMsg_PlayerUpdate::SetPlayerID(lyra_id_t playerid)
{
    data_.playerid = playerid;
}

void RMsg_PlayerUpdate::SetPeerUpdate(int num, const LmPeerUpdate& update)
{
