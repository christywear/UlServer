...
#include "../../../include/Protocol/RMsg/RMsg_NewlyAwakened.h"
...
#ifndef USE_DEBUG
void RMsg_NewlyAwakened::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

const TCHAR* RMsg_NewlyAwakened::PlayerName(void) const
{
    return data_.playername;
}

lyra_id_t RMsg_NewlyAwakened::RoomID(void) const
{
    return data_.roomid;
}

void RMsg_NewlyAwakened::SetLocation(lyra_id_t roomid)
{
    data_.roomid = roomid;
}