...
#include "../../../include/Protocol/RMsg/RMsg_EnterRoom.h"
...
#ifndef USE_DEBUG
void RMsg_EnterRoom::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int RMsg_EnterRoom::NumPlayers() const
{
    return num_players_;
}

const RmRemotePlayer& RMsg_EnterRoom::Player(int num) const
{
    return data_.players[num];
}

void RMsg_EnterRoom::SetPlayer(int num, const RmRemotePlayer& p)
{
    data_.players[num] = p;
}