...
#include "../../../include/Protocol/RMsg/RMsg_Error.h"
...
#ifndef USE_DEBUG
void RMsg_Error::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int RMsg_Error::ErrorStringLength() const
{
	return data_.err_len;
}

int RMsg_Error::MsgType() const
{
	return data_.msg_type;
}

const TCHAR* RMsg_Error::ErrorString() const
{
	return data_.err_msg;
}

void RMsg_Error::SetMsgType(int mesgtype)
{
