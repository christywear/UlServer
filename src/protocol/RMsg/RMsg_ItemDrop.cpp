...
#include "../../../include/Protocol/RMsg/RMsg_ItemDrop.h"
...
#ifndef USE_DEBUG
void RMsg_ItemDrop::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int RMsg_ItemDrop::NumItems() const
{
    return num_items_;
}

const LmItem& RMsg_ItemDrop::Item(int num) const
{
    return data_.items[num].item;
}

const LmPosition& RMsg_ItemDrop::Position(int num) const
{
    return data_.items[num].pos;
}

void RMsg_ItemDrop::SetItem(int num, const LmItem& item, const LmPosition& pos)
{
