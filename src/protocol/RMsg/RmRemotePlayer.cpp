...
#ifndef USE_DEBUG
void RmRemotePlayer::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t RmRemotePlayer::PlayerID() const
{
	return rp_.playerid;
}

lyra_id_t RmRemotePlayer::Room() const
{
	return rp_.room;
}

const LmAvatar& RmRemotePlayer::Avatar() const
{
	return rp_.avatar;
}

const TCHAR* RmRemotePlayer::PlayerName() const
{
	return rp_.playername;
}

const LmPeerUpdate& RmRemotePlayer::PeerUpdate() const
{
	return rp_.update;
}

void RmRemotePlayer::SetAvatar(const LmAvatar& avatar)
{
	rp_.avatar = avatar;
}

void RmRemotePlayer::SetRoom(lyra_id_t room)
{
	rp_.room = room;
}

void RmRemotePlayer::SetPlayerID(lyra_id_t playerid)
{
	rp_.playerid = playerid;
}

void RmRemotePlayer::SetPeerUpdate(const LmPeerUpdate& update)
{
	rp_.update = update;
}
