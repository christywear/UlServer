...
#include "../../../include/Protocol/RMsg/RMsg_RcvAvatarDescription.h"
...
#ifndef USE_DEBUG
void RMsg_RcvAvatarDescription::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t RMsg_RcvAvatarDescription::PlayerID() const
{
	return data_.playerid;
}

const TCHAR* RMsg_RcvAvatarDescription::Description() const
{
	return data_.description;
}

void RMsg_RcvAvatarDescription::SetPlayerID(lyra_id_t playerid)
{
