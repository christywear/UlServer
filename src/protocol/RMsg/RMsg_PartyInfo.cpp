...
#include "../../../include/Protocol/RMsg/RMsg_PartyInfo.h"
...
#ifndef USE_DEBUG
void RMsg_PartyInfo::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t RMsg_PartyInfo::LeaderID() const
{
    return data_.leaderid;
}

int RMsg_PartyInfo::PartySize() const
{
    return num_members_;
}

const RmRemotePlayer& RMsg_PartyInfo::PartyMember(int num) const
{
    return data_.members[num];
}

void RMsg_PartyInfo::SetLeaderID(lyra_id_t leaderid)
{
    data_.leaderid = leaderid;
}

void RMsg_PartyInfo::SetPartyMember(int num, const RmRemotePlayer& p)
{
    data_.members[num] = p;
}
