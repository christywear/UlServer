...
#include "../../../include/Protocol/RMsg/RMsg_PlayerMsg.h"
...
#ifndef USE_DEBUG
void RMsg_PlayerMsg::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t RMsg_PlayerMsg::SenderID() const
{
	return data_.senderid;
}

lyra_id_t RMsg_PlayerMsg::ReceiverID() const
{
	return data_.receiverid;
}

int RMsg_PlayerMsg::MsgType() const
{
	return data_.mtype;
}

int RMsg_PlayerMsg::State1() const
{
	return data_.state1;
}

int RMsg_PlayerMsg::State2() const
{
	return data_.state2;
}

int RMsg_PlayerMsg::State3() const
{
	return data_.state3;
}

void RMsg_PlayerMsg::SetSenderID(lyra_id_t playerid)
{
	data_.senderid = playerid;
}

void RMsg_PlayerMsg::SetReceiverID(lyra_id_t playerid)
{
	data_.receiverid = playerid;
}

void RMsg_PlayerMsg::SetMsgType(int message_type)
{
	data_.mtype = message_type;
}

void RMsg_PlayerMsg::SetState1(int byte1)
{
	data_.state1 = byte1;
}

void RMsg_PlayerMsg::SetState2(int byte2)
{
	data_.state2 = byte2;
}

void RMsg_PlayerMsg::SetState3(int byte3)
{
	data_.state3 = byte3;
}

bool RMsg_PlayerMsg::Universal() const
{
	return data_.universal;
}

void RMsg_PlayerMsg::SetUniversal(bool universal)
{
