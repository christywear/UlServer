...
#ifndef USE_DEBUG
void RMsg_ItemPickup::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int RMsg_ItemPickup::NumItems() const
{
    return num_items_;
}

const LmItemHdr& RMsg_ItemPickup::ItemHeader(int num) const
{
    return data_.itemhdrs[num];
}

void RMsg_ItemPickup::SetItemHeader(int num, const LmItemHdr& itemhdr)
{
    data_.itemhdrs[num] = itemhdr;
}

void RMsg_ItemPickup::SetItem(int num, const LmItem& item)
{
