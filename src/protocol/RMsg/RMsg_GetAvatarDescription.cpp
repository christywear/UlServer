...
#include "../../../include/Protocol/RMsg/RMsg_GetAvatarDescription.h"
...
#ifndef USE_DEBUG
void RMsg_GetAvatarDescription::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t RMsg_GetAvatarDescription::PlayerID() const
{
	return data_.playerid;
}

void RMsg_GetAvatarDescription::SetPlayerID(lyra_id_t playerid)
{
