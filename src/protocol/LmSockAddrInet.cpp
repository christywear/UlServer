...
int LmSockAddrInet::Port() const
{
    return ntohs(addr_.sin_port);
}

unsigned long LmSockAddrInet::IPAddress() const
{
    return addr_.sin_addr.s_addr;
}

int LmSockAddrInet::Family() const
{
    return addr_.sin_family;
}

sockaddr* LmSockAddrInet::SockAddr() const
{
    return (sockaddr*)&addr_;
}

int LmSockAddrInet::SockAddrSize() const
{
    return sizeof(addr_);
}

void LmSockAddrInet::SetPort(unsigned short port)
{
    addr_.sin_port = htons(port);
}