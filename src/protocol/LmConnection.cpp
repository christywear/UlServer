...
time_t LmConnection::ConnectTime() const
{
    return time_connect_;
}

time_t LmConnection::LastIn() const
{
    return time_in_;
}

time_t LmConnection::LastOut() const
{
    return time_out_;
}

int LmConnection::MessagesIn() const
{
    return msgs_in_;
}

int LmConnection::MessagesInRate() const
{
    return MessagesIn() / Online();
}

int LmConnection::MessagesOut() const
{
    return msgs_out_;
}

int LmConnection::MessagesOutRate() const
{
    return MessagesOut() / Online();
}

int LmConnection::BytesIn() const
{
    return bytes_in_;
}

int LmConnection::BytesInRate() const
{
    return BytesIn() / Online();
}

int LmConnection::BytesOut() const
{
    return bytes_out_;
}

int LmConnection::BytesOutRate() const
{
    return BytesOut() / Online();
}

void LmConnection::SetID(lyra_id_t id)
{
    id_ = id;
}

void LmConnection::SetType(int contype)
{
    type_ = contype;
}

LmSocket& LmConnection::Socket()
{
    return sock_;
}

lyra_id_t LmConnection::ID() const
{
    return id_;
}

int LmConnection::Type() const
{
    return type_;
}

time_t LmConnection::Online() const
{
    // don't return 0 ever
...
time_t LmConnection::IdleIn() const
{
    return LmUtil::TimeSince(time_in_);
}

time_t LmConnection::IdleOut() const
{
    return LmUtil::TimeSince(time_out_);
}

bool LmConnection::IsConnected() const
{
    return is_connected_;
}

#if 0
bool LmConnection::IsClosed() const
{
    return is_closed_;
}
#endif

void LmConnection::SetMessageRange(int min_mtype, int max_mtype)
{
    msg_min_ = min_mtype;
    msg_max_ = max_mtype;
}

int LmConnection::MinMessageType() const
{
    return msg_min_;
}

int LmConnection::MaxMessageType() const
{
    return msg_max_;
}

time_t LmConnection::ChallengeTime() const
{
    return challenge_time_;
}

TCHAR* LmConnection::Challenge() const
{
    return (TCHAR*)(challenge_);
}

void LmConnection::SetChallengeTime()
{
    time(&challenge_time_);
}

void LmConnection::SetChallenge(TCHAR* value)
{
