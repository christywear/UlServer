...
#include "../../../include/Protocol/SMsg/SMsg_ItemPickup.h"
...
lyra_id_t SMsg_ItemPickup::PlayerID() const
{
    return data_.playerid;
}

const LmItem& SMsg_ItemPickup::Item() const
{
    return data_.item;
}

int SMsg_ItemPickup::Status() const
{
    return data_.status;
}

void SMsg_ItemPickup::SetItem(const LmItem& item)
{
    data_.item = item;
}

void SMsg_ItemPickup::SetStatus(int status)
{
    data_.status = status;
}

void SMsg_ItemPickup::SetPlayerID(lyra_id_t playerid)
{
