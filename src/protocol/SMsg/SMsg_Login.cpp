...
#include "../../../include/Protocol/SMsg/SMsg_Login.h"
...
int SMsg_Login::ServerType() const
{
	return data_.servertype;
}

lyra_id_t SMsg_Login::ID() const
{
	return data_.id;
}

void SMsg_Login::SetServerType(int servertype)
{
	data_.servertype = servertype;
}

void SMsg_Login::SetID(lyra_id_t id)
{
	data_.id = id;
}
