...
#include "../../../include/Protocol/SMsg/SMsg_Error.h"
...
int SMsg_Error::MsgType() const
{
	return data_.msg_type;
}

int SMsg_Error::ErrorStringLength() const
{
	return data_.err_len;
}

const TCHAR* SMsg_Error::ErrorString() const
{
	return data_.err_msg;
}

void SMsg_Error::SetMsgType(int mesgtype)
{
