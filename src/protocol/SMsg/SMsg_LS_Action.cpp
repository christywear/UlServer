...
int SMsg_LS_Action::Action() const
{
	return data_.action;
}

void SMsg_LS_Action::SetAction(int action)
{
	data_.action = action;
}

int SMsg_LS_Action::Parameter() const
{
	return data_.parameter;
}

void SMsg_LS_Action::SetParameter(int parameter)
{
