...
#include "../../../include/Protocol/SMsg/SMsg_Proxy.h"
...
void SMsg_Proxy::InitProcess(lyra_id_t playerid, LmMesg& msg)
{
	Init(playerid, PROXY_PROCESS, msg);
}

void SMsg_Proxy::InitProcess(lyra_id_t playerid, LmMesgBuf* msgbuf)
{
	Init(playerid, PROXY_PROCESS, msgbuf);
}

void SMsg_Proxy::InitForward(lyra_id_t playerid, LmMesg& msg)
{
	Init(playerid, PROXY_FORWARD, msg);
}

void SMsg_Proxy::InitForward(lyra_id_t playerid, LmMesgBuf* msgbuf)
{
	Init(playerid, PROXY_FORWARD, msgbuf);
}

lyra_id_t SMsg_Proxy::PlayerID() const
{
	return data_.playerid;
}

int SMsg_Proxy::ProxyType() const
{
	return data_.ptype;
}

int SMsg_Proxy::EnclosedMessageType() const
{
	return data_.mtype;
}

int SMsg_Proxy::EnclosedMessageSize() const
{
	return data_.msize;
}

const TCHAR* SMsg_Proxy::MessageBytes() const
{
	return data_.msgbytes;
}

void SMsg_Proxy::SetPlayerID(lyra_id_t playerid)
{
	data_.playerid = playerid;
}

void SMsg_Proxy::SetProxyType(int proxy_type)
{
