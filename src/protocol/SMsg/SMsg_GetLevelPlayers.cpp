...
#include "../../../include/Protocol/SMsg/SMsg_GetLevelPlayers.h"
...
lyra_id_t SMsg_GetLevelPlayers::PlayerID() const
{
	return data_.playerid;
}

void SMsg_GetLevelPlayers::SetPlayerID(lyra_id_t playerid)
{
