...
#ifndef USE_DEBUG
void SMsg_DBQuery::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t SMsg_DBQuery::ID() const
{
	return data_.player_id;
}

unsigned char SMsg_DBQuery::Result() const
{
	return data_.result;
}

unsigned char SMsg_DBQuery::DB() const
{
	return data_.db;
}

unsigned char SMsg_DBQuery::ThreadType() const
{
	return data_.thread_type;
}

const TCHAR* SMsg_DBQuery::Query() const
{
	return data_.query;
}

void SMsg_DBQuery::SetResult(unsigned char result)
{
	data_.result = result;
}

void SMsg_DBQuery::SetDB(unsigned char db)
{
	data_.db = db;
}

void SMsg_DBQuery::SetThreadType(unsigned char thread_type)
{
	data_.thread_type = thread_type;
}

void SMsg_DBQuery::SetID(lyra_id_t id)
{
	data_.player_id = id;
}
