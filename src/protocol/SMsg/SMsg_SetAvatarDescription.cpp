...
#include "../../../include/Protocol/SMsg/SMsg_SetAvatarDescription.h"
...
#ifndef USE_DEBUG
void SMsg_SetAvatarDescription::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t SMsg_SetAvatarDescription::PlayerID() const
{
	return data_.playerid;
}

const TCHAR* SMsg_SetAvatarDescription::Description() const
{
	return data_.description;
}

void SMsg_SetAvatarDescription::SetPlayerID(lyra_id_t playerid)
{
