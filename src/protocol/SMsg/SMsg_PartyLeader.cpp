...
#include "../../../include/Protocol/SMsg/SMsg_PartyLeader.h"
...
lyra_id_t SMsg_PartyLeader::PlayerID() const
{
	return data_.playerid;
}

int SMsg_PartyLeader::LeaderTime() const
{
	return data_.leader_time;
}

void SMsg_PartyLeader::SetPlayerID(lyra_id_t playerid)
{
	data_.playerid = playerid;
}

void SMsg_PartyLeader::SetLeaderTime(int leader_time)
{
