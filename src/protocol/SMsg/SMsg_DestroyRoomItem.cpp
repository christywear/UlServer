...
#include "../../../include/Protocol/SMsg/SMsg_DestroyRoomItem.h"
...
lyra_id_t SMsg_DestroyRoomItem::PlayerID() const
{
    return data_.playerid;
}

lyra_id_t SMsg_DestroyRoomItem::RoomID() const
{
    return data_.roomid;
}

const LmItemHdr& SMsg_DestroyRoomItem::ItemHeader() const
{
    return data_.itemhdr;
}

void SMsg_DestroyRoomItem::SetRoomID(lyra_id_t roomid)
{
    data_.roomid = roomid;
}

void SMsg_DestroyRoomItem::SetPlayerID(lyra_id_t playerid)
{
    data_.playerid = playerid;
}

void SMsg_DestroyRoomItem::SetItemHeader(const LmItemHdr& itemhdr)
{
