...
#include "../../../include/Protocol/SMsg/SMsg_GetServerStatus.h"
...
int SMsg_GetServerStatus::Status() const
{
	return data_.status;
}

lyra_id_t SMsg_GetServerStatus::ID() const
{
	return data_.id;
}

void SMsg_GetServerStatus::SetStatus(int status)
{
	data_.status = status;
}

void SMsg_GetServerStatus::SetID(lyra_id_t id)
{
	data_.id = id;
}