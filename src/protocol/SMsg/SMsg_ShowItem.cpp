...
#include "../../../include/Protocol/SMsg/SMsg_ShowItem.h"
...
#ifndef USE_DEBUG
void SMsg_ShowItem::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t SMsg_ShowItem::SourceID() const
{
	return data_.sourceid;
}

lyra_id_t SMsg_ShowItem::TargetID() const
{
	return data_.targetid;
}

const LmItemHdr& SMsg_ShowItem::ItemHeader() const
{
	return data_.itemheader;
}

const TCHAR* SMsg_ShowItem::ItemName() const
{
	return data_.itemname;
}

void SMsg_ShowItem::SetSourceID(lyra_id_t sourceid)
{
	data_.sourceid = sourceid;
}

void SMsg_ShowItem::SetTargetID(lyra_id_t targetid)
{
	data_.targetid = targetid;
}

void SMsg_ShowItem::SetItemHeader(const LmItemHdr& itemheader)
{
