...
int LmSrvMesgBuf::UseCount() const
{
    return use_count_;
}

void LmSrvMesgBuf::SetUseCount(int use)
{
    use_count_ = use;
    total_uses_ += use;
}

void LmSrvMesgBuf::AddReference()
{
    use_count_++;
    total_uses_++;
}

void LmSrvMesgBuf::RemoveReference()
{
    use_count_--;
}

int LmSrvMesgBuf::TotalUses() const
{
    return total_uses_;
}

time_t LmSrvMesgBuf::CreationTime() const
{
    return creation_time_;
}

time_t LmSrvMesgBuf::LastUseTime() const
{
    return last_use_;
}

void LmSrvMesgBuf::SetUseTime(time_t usetime)
{
    last_use_ = usetime;
}
