...
#include "../../include/Protocol/LmNetworkInput.h"
...
#include "../../include/Protocol/LmMessageReader.h"
...
LmDispatch* LmNetworkInput::Dispatch()
{
    return dispatch_;
}

LmConnectionSet* LmNetworkInput::ConnectionSet()
{
    return cset_;
}
