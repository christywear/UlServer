...
#include "../../../include/Protocol/GMsg/GMsg_RcvReportGoals.h"
...
#ifndef USE_DEBUG
void GMsg_RcvReportGoals::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */
...
lyra_id_t GMsg_RcvReportGoals::GoalID() const
{
	return data_.goalid;
}

void GMsg_RcvReportGoals::SetGoalID(lyra_id_t goalid)
{
	data_.goalid = goalid;
}
