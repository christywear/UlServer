...
#ifndef USE_DEBUG
void GMsg_Ping::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int GMsg_Ping::Nonce() const
{
	return data_.nonce;
}

int GMsg_Ping::PingType() const
{
	return data_.ping_type;
}

void GMsg_Ping::SetNonce(int nonce)
{
	data_.nonce = nonce;
}

void GMsg_Ping::SetPingType(int ping_type)
{
