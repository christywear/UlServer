...
#include "../../../include/Protocol/GMsg/GMsg_CreateItem.h"
...
#ifndef USE_DEBUG
void GMsg_CreateItem::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

const LmItem& GMsg_CreateItem::Item() const
{
    return data_.item;
}

const TCHAR* GMsg_CreateItem::Description() const
{
    return data_.desc;
}

void GMsg_CreateItem::SetItem(const LmItem& item)
{
    data_.item = item;
}