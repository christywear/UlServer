...
#include "../../../include/Protocol/GMsg/GMsg_RcvPlayerName.h"
...
lyra_id_t GMsg_RcvPlayerName::PlayerID() const
{
	return data_.playerid;
}

int GMsg_RcvPlayerName::RequestID() const
{
	return data_.requestid;
}

const TCHAR* GMsg_RcvPlayerName::PlayerName() const
{
	return data_.playername;
}

void GMsg_RcvPlayerName::SetPlayerID(lyra_id_t playerid)
{
	data_.playerid = playerid;
}

void GMsg_RcvPlayerName::SetRequestID(int requestid)
{
