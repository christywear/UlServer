...
#include "../../../include/Protocol/GMsg/GMsg_RcvReportHdr.h"
...
#ifndef USE_DEBUG
void GMsg_RcvReportHdr::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_RcvReportHdr::ReportID() const
{
	return data_.reportid;
}

lyra_id_t GMsg_RcvReportHdr::GoalID() const
{
	return data_.goalid;
}

short GMsg_RcvReportHdr::SessionID() const
{
	return data_.sessionid;
}

unsigned short GMsg_RcvReportHdr::Flags() const
{
	return data_.flags;
}

const TCHAR* GMsg_RcvReportHdr::Summary() const
{
	return data_.summary;
}

void GMsg_RcvReportHdr::SetReportID(lyra_id_t reportid)
{
	data_.reportid = reportid;
}

void GMsg_RcvReportHdr::SetGoalID(lyra_id_t goalid)
{
	data_.goalid = goalid;
}

void GMsg_RcvReportHdr::SetSessionID(short sessionid)
{
	data_.sessionid = sessionid;
}

void GMsg_RcvReportHdr::SetFlags(unsigned short flags)
{
	data_.flags = flags;
}
