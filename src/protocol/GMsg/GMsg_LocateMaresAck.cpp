...
#include "../../../include/Protocol/GMsg/GMsg_LocateMaresAck.h"
...
#ifndef USE_DEBUG
void GMsg_LocateMaresAck::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int GMsg_LocateMaresAck::NumPlayers() const
{
    return num_players_;
}

const TCHAR* GMsg_LocateMaresAck::PlayerName(int player_num) const
{
    return data_.players[player_num].playername;
}

short GMsg_LocateMaresAck::LevelID(int player_num) const
{
    return data_.players[player_num].levelid;
}

short GMsg_LocateMaresAck::RoomID(int player_num) const
{
    return data_.players[player_num].roomid;
}

void GMsg_LocateMaresAck::SetLocation(int player_num, short levelid, short roomid)
{
