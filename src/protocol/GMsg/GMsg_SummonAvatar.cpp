...
#include "../../../include/Protocol/GMsg/GMsg_SummonAvatar.h"
...
#ifndef USE_DEBUG
void GMsg_SummonAvatar::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int GMsg_SummonAvatar::NumPlayers() const
{
    return num_players_;
}

const char* GMsg_SummonAvatar::PlayerName(int player_num) const
{
