...
#include "../../../include/Protocol/GMsg/GMsg_GetPlayerName.h"
...
#ifndef USE_DEBUG
void GMsg_GetPlayerName::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_GetPlayerName::PlayerID() const
{
	return data_.playerid;
}

int GMsg_GetPlayerName::RequestID() const
{
	return data_.requestid;
}

void GMsg_GetPlayerName::SetPlayerID(lyra_id_t playerid)
{
	data_.playerid = playerid;
}

void GMsg_GetPlayerName::SetRequestID(int requestid)
{
