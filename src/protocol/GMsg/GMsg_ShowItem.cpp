...
#include "../../../include/Protocol/GMsg/GMsg_ShowItem.h"
...
#ifndef USE_DEBUG
void GMsg_ShowItem::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_ShowItem::TargetID() const
{
	return data_.targetid;
}

const LmItemHdr& GMsg_ShowItem::ItemHeader() const
{
	return data_.itemheader;
}

void GMsg_ShowItem::SetTargetID(lyra_id_t targetid)
{
	data_.targetid = targetid;
}

void GMsg_ShowItem::SetItemHeader(const LmItemHdr& itemheader)
{
