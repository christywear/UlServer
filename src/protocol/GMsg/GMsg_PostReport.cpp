...
#include "../../../include/Protocol/GMsg/GMsg_PostReport.h"
...
#ifndef USE_DEBUG
void GMsg_PostReport::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_PostReport::GoalID() const
{
	return data_.goalid;
}

int GMsg_PostReport::AwardXP() const
{
	return data_.awardxp;
}

const TCHAR* GMsg_PostReport::Recipient() const
{
	return data_.recipient;
}

const TCHAR* GMsg_PostReport::Summary() const
{
	return data_.summary;
}

const TCHAR* GMsg_PostReport::ReportText() const
{
	return data_.reporttext;
}

void GMsg_PostReport::SetGoalID(lyra_id_t goalid)
{
	data_.goalid = goalid;
}

void GMsg_PostReport::SetAwardXP(int awardxp)
{
