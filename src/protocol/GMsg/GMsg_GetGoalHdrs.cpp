...
#include "../../../include/Protocol/GMsg/GMsg_GetGoalHdrs.h"
...
#ifndef USE_DEBUG
void GMsg_GetGoalHdrs::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int GMsg_GetGoalHdrs::SessionID() const
{
	return data_.sessionid;
}

short GMsg_GetGoalHdrs::Guild() const
{
	return data_.guild;
}

short GMsg_GetGoalHdrs::LevelNum() const
{
	return data_.level_num;
}

lyra_id_t GMsg_GetGoalHdrs::LastGoal() const
{
	return data_.lastgoal;
}

void GMsg_GetGoalHdrs::SetSessionID(int sessionid)
{
	data_.sessionid = sessionid;
}

void GMsg_GetGoalHdrs::SetGuild(short guild)
{
	data_.guild = guild;
}

void GMsg_GetGoalHdrs::SetLevelNum(short level_num)
{
	data_.level_num = level_num;
}

void GMsg_GetGoalHdrs::SetLastGoal(lyra_id_t lastgoal)
{
