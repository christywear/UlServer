...
#include "../../../include/Protocol/GMsg/GMsg_GetItemDescription.h"
...
#ifndef USE_DEBUG
void GMsg_GetItemDescription::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

const LmItemHdr& GMsg_GetItemDescription::ItemHeader() const
{
	return data_.itemheader;
}

void GMsg_GetItemDescription::SetItemHeader(const LmItemHdr& itemheader)
{
