...
#include "../../../include/Protocol/GMsg/GMsg_ItemDescription.h"
...
#ifndef USE_DEBUG
void GMsg_ItemDescription::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int GMsg_ItemDescription::Serial() const
{
	return data_.serial;
}

const TCHAR* GMsg_ItemDescription::Creator() const
{
	return data_.creator;
}

const TCHAR* GMsg_ItemDescription::Description() const
{
	return data_.description;
}

const TCHAR* GMsg_ItemDescription::Target() const
{
	return data_.target;
}

void GMsg_ItemDescription::SetSerial(int serial)
{
	data_.serial = serial;
}
