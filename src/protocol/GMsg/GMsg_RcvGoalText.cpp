...
#include "../../../include/Protocol/GMsg/GMsg_RcvGoalText.h"
...
#ifndef USE_DEBUG
void GMsg_RcvGoalText::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_RcvGoalText::GoalID() const
{
	return data_.goalid;
}

short GMsg_RcvGoalText::SugSphere() const
{
	return data_.sugsphere;
}

short GMsg_RcvGoalText::SugStat() const
{
	return data_.sugstat;
}

const TCHAR* GMsg_RcvGoalText::Creator() const
{
	return data_.creator;
}

const TCHAR* GMsg_RcvGoalText::GoalText() const
{
	return data_.goaltext;
}

void GMsg_RcvGoalText::SetGoalID(lyra_id_t goalid)
{
	data_.goalid = goalid;
}

void GMsg_RcvGoalText::SetSugSphere(short sugsphere)
{
	data_.sugsphere = sugsphere;
}

void GMsg_RcvGoalText::SetSugStat(short sugstat)
{
	data_.sugstat = sugstat;
}

lyra_id_t GMsg_RcvGoalText::CreatorID() const
{
	return creatorid_;
}

void GMsg_RcvGoalText::SetCreatorID(lyra_id_t creatorid)
{
