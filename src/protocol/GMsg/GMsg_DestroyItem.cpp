...
#include "../../../include/Protocol/GMsg/GMsg_DestroyItem.h"
...
#ifndef USE_DEBUG
void GMsg_DestroyItem::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

const LmItemHdr& GMsg_DestroyItem::ItemHeader() const
{
    return data_.itemhdr;
}

void GMsg_DestroyItem::SetItemHeader(const LmItemHdr& itemhdr)
{
