...
#include "../../../include/Protocol/GMsg/GMsg_LevelPlayers.h"
...
#ifndef USE_DEBUG
void GMsg_LevelPlayers::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_LevelPlayers::LevelID() const
{
    return data_.levelid;
}

int GMsg_LevelPlayers::NumRooms() const
{
    return data_.num_rooms;
}

lyra_id_t GMsg_LevelPlayers::RoomID(int index) const
{
    return data_.rooms[index].roomid;
}

int GMsg_LevelPlayers::NumPlayers(int index) const
{
    return data_.rooms[index].num_players;
}

int GMsg_LevelPlayers::NumAgents(int index) const
{
    return data_.rooms[index].num_agents;
}

void GMsg_LevelPlayers::SetLevelID(lyra_id_t levelid)
{
    data_.levelid = levelid;
}

void GMsg_LevelPlayers::SetRoomID(int index, lyra_id_t roomid)
{
    data_.rooms[index].roomid = roomid;
}

void GMsg_LevelPlayers::SetNumPlayers(int index, int num_players)
{
    data_.rooms[index].num_players = num_players;
}

void GMsg_LevelPlayers::SetNumAgents(int index, int num_agents)
{
