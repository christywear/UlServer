...
#include "../../../include/Protocol/GMsg/GMsg_SummonAvatarAck.h"
...
#ifndef USE_DEBUG
void GMsg_SummonAvatarAck::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int GMsg_SummonAvatarAck::NumPlayers() const
{
	return num_players_;
}

const char* GMsg_SummonAvatarAck::PlayerName(int player_num) const
{
	return data_.players[player_num].playername;
}

lyra_id_t GMsg_SummonAvatarAck::LevelID(int player_num) const
{
	return data_.players[player_num].levelid;
}

lyra_id_t GMsg_SummonAvatarAck::RoomID(int player_num) const
{
	return data_.players[player_num].roomid;
}

int GMsg_SummonAvatarAck::Status(int player_num) const
{
	return data_.players[player_num].status;
}

void GMsg_SummonAvatarAck::SetStatus(int player_num, int status)
{
	data_.players[player_num].status = status;
}

void GMsg_SummonAvatarAck::SetLocation(int player_num, lyra_id_t caster_id, int x, int y, int height, int angle, lyra_id_t levelid, lyra_id_t roomid)
{
