...
#include "../../../include/Protocol/GMsg/GMsg_PreLogin.h"
...
#ifndef USE_DEBUG
void GMsg_PreLogin::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int GMsg_PreLogin::Version() const
{
	return data_.version;
}

void GMsg_PreLogin::SetVersion(int version)
{
