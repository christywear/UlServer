...
#include "../../../include/Protocol/GMsg/GMsg_GetItem.h"
...
#ifndef USE_DEBUG
void GMsg_GetItem::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_GetItem::RoomID() const
{
    return data_.roomid;
}

const LmItemHdr& GMsg_GetItem::ItemHeader() const
{
    return data_.itemhdr;
}

void GMsg_GetItem::SetRoomID(lyra_id_t roomid)
{
    data_.roomid = roomid;
}

void GMsg_GetItem::SetItemHeader(const LmItemHdr& itemhdr)
{
    data_.itemhdr = itemhdr;
}

#ifndef USE_DEBUG
void GMsg_GiveItem::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_GiveItem::TargetID() const
{
    return data_.targetid;
}

const LmItemHdr& GMsg_GiveItem::ItemHeader() const
{
    return data_.itemheader;
}

void GMsg_GiveItem::SetTargetID(lyra_id_t targetid)
{
    data_.targetid = targetid;
}

void GMsg_GiveItem::SetItemHeader(const LmItemHdr& itemheader)
{
