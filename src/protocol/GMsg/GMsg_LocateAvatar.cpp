...
#include "../../../include/Protocol/GMsg/GMsg_LocateAvatar.h"
...
#ifndef USE_DEBUG
void GMsg_LocateAvatar::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int GMsg_LocateAvatar::NumPlayers() const
{
    return num_players_;
}

const TCHAR* GMsg_LocateAvatar::PlayerName(int player_num) const
{
