...
#include "../../../include/Protocol/GMsg/GMsg_ViewItem.h"
...
#ifndef USE_DEBUG
void GMsg_ViewItem::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_ViewItem::SourceID() const
{
    return data_.sourceid;
}

const LmItemHdr& GMsg_ViewItem::ItemHeader() const
{
    return data_.itemheader;
}

const TCHAR* GMsg_ViewItem::ItemName() const
{
    return data_.itemname;
}

void GMsg_ViewItem::SetSourceID(lyra_id_t sourceid)
{
    data_.sourceid = sourceid;
}

void GMsg_ViewItem::SetItemHeader(const LmItemHdr& itemheader)
{
