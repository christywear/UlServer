...
#include "../../../include/Protocol/GMsg/GMsg_Error.h"
...
#ifndef USE_DEBUG
void GMsg_Error::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

int GMsg_Error::MsgType() const
{
	return data_.msg_type;
}

int GMsg_Error::ErrorStringLength() const
{
	return data_.err_len;
}

const TCHAR* GMsg_Error::ErrorString() const
{
	return data_.err_msg;
}

void GMsg_Error::SetMsgType(int mesgtype)
{
