...
#include "../../../include/Protocol/GMsg/GMsg_LocateAvatarAck.h"
...
#ifndef USE_DEBUG
void GMsg_LocateAvatarAck::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

int GMsg_LocateAvatarAck::NumPlayers() const
{
    return num_players_;
}

const TCHAR* GMsg_LocateAvatarAck::PlayerName(int player_num) const
{
    return data_.players[player_num].playername;
}

lyra_id_t GMsg_LocateAvatarAck::LevelID(int player_num) const
{
    return data_.players[player_num].levelid;
}

lyra_id_t GMsg_LocateAvatarAck::RoomID(int player_num) const
{
    return data_.players[player_num].roomid;
}

int GMsg_LocateAvatarAck::Status(int player_num) const
{
    return data_.players[player_num].status;
}

void GMsg_LocateAvatarAck::SetStatus(int player_num, int status)
{
    data_.players[player_num].status = status;
}

void GMsg_LocateAvatarAck::SetLocation(int player_num, lyra_id_t levelid, lyra_id_t roomid)
{
