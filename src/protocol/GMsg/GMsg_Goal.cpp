...
#include "../../../include/Protocol/GMsg/GMsg_Goal.h"
...
#ifndef USE_DEBUG
void GMsg_Goal::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_Goal::ID() const
{
	return data_.id;
}

int GMsg_Goal::RequestType() const
{
	return data_.messagetyp;
}

void GMsg_Goal::SetID(lyra_id_t id)
{
	data_.id = id;
}

void GMsg_Goal::SetRequestType(int messagetyp)
{
