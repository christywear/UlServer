...
#include "../../../include/Protocol/GMsg/GMsg_SetAvatarDescription.h"
...
#ifndef USE_DEBUG
void GMsg_SetAvatarDescription::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

const TCHAR* GMsg_SetAvatarDescription::Description() const
{
