...
#ifndef USE_DEBUG
void GMsg_SenseDreamersAck::Dump(FILE*, int) const
{
    // empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_SenseDreamersAck::LevelID(int index) const
{
    return (lyra_id_t)(data_.level_id[index]);
}

unsigned int GMsg_SenseDreamersAck::Total() const
{
    return data_.total;
}

void GMsg_SenseDreamersAck::SetTotal(unsigned int total)
{
    data_.total = total;
}

//int GMsg_SenseDreamersAck::NumDreamers(int index) const
//{
