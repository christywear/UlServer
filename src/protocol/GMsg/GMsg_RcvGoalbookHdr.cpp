...
#include "../../../include/Protocol/GMsg/GMsg_RcvGoalbookHdr.h"
...
#ifndef USE_DEBUG
void GMsg_RcvGoalbookHdr::Dump(FILE*, int) const
{
	// empty
}
#endif /* !USE_DEBUG */

lyra_id_t GMsg_RcvGoalbookHdr::GoalID() const
{
	return data_.goalid;
}

short GMsg_RcvGoalbookHdr::Guild() const
{
	return data_.guild;
}

short GMsg_RcvGoalbookHdr::Rank() const
{
	return data_.rank;
}

const TCHAR* GMsg_RcvGoalbookHdr::Summary() const
{
	return data_.summary;
}

void GMsg_RcvGoalbookHdr::SetGoalID(lyra_id_t goalid)
{
	data_.goalid = goalid;
}

void GMsg_RcvGoalbookHdr::SetGuild(short guild)
{
	data_.guild = guild;
}

void GMsg_RcvGoalbookHdr::SetRank(short rank)
{
	data_.rank = rank;
}
