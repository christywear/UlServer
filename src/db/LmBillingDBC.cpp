...
long LmBillingDBC::LastSQLCode() const
{
	return last_sql_code_;
}

void LmBillingDBC::SetLog(LmLog* log)
{
	log_ = log;
}

LmLog* LmBillingDBC::Log() const
{
	return log_;
}

long LmBillingDBC::LastCallTime() const
{
	return last_ms_;
}

long LmBillingDBC::TotalCallTime() const
{
	return num_ms_;
}

long LmBillingDBC::TotalSQLTime() const
{
	return sql_ms_;
}
