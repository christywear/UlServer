...
const LmPosition& LmItemGenDB::Position() const
{
    return pos_;
}

int LmItemGenDB::GeneratorType() const
{
    return gen_type_;
}

int LmItemGenDB::BaseDelay() const
{
    return base_delay_;
}

int LmItemGenDB::VarDelay() const
{
    return var_delay_;
}

int LmItemGenDB::ItemTTL() const
{
    return item_ttl_;
}

int LmItemGenDB::VarTTL() const
{
    return var_ttl_;
}