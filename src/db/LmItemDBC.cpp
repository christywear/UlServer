...
long LmItemDBC::LastSQLCode() const
{
    return last_sql_code_;
}

void LmItemDBC::SetLog(LmLog* log)
{
    log_ = log;
}

LmLog* LmItemDBC::Log() const
{
    return log_;
}


long LmItemDBC::LastCallTime() const
{
    return last_ms_;
}

long LmItemDBC::TotalCallTime() const
{
    return num_ms_;
}

long LmItemDBC::TotalSQLTime() const
{
    return sql_ms_;
}
