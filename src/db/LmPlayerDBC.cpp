...
long LmPlayerDBC::LastSQLCode() const
{
    return last_sql_code_;
}

void LmPlayerDBC::SetLog(LmLog* log)
{
    log_ = log;
}

LmLog* LmPlayerDBC::Log() const
{
    return log_;
}

int LmPlayerDBC::NumCalls() const
{
    return num_calls_;
}

long LmPlayerDBC::LastCallTime() const
{
    return last_ms_;
}

long LmPlayerDBC::TotalCallTime() const
{
    return num_ms_;
}

long LmPlayerDBC::TotalSQLTime() const
{
    return sql_ms_;
}