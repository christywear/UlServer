...
LmLog* LmLevelDBC::Log() const
{
    return log_;
}

long LmLevelDBC::LastCallTime() const
{
    return last_ms_;
}

long LmLevelDBC::TotalCallTime() const
{
    return num_ms_;
}

long LmLevelDBC::TotalSQLTime() const
{
    return sql_ms_;
}

lyra_id_t LmLevelDBC::LevelID() const
{
    return level_id_;
}

const TCHAR* LmLevelDBC::LevelName() const
{
    return level_name_;
}

int LmLevelDBC::NumRooms() const
{
    return num_rooms_;
}

int LmLevelDBC::MaxPlayers() const
{
    return max_players_;
}