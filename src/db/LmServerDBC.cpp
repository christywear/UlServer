...
int LmServerDBC::NumServers() const
{
    return num_servers_;
}

const TCHAR* LmServerDBC::HostName(int index) const
{
    return servers_[index].hostname;
}

const TCHAR* LmServerDBC::HostID(int index) const
{
    return servers_[index].hostid;
}

unsigned long LmServerDBC::HostIPAddr(int index) const
{
    return servers_[index].host_addr;
}

int LmServerDBC::ServerType(int index) const
{
    return servers_[index].servertype;
}

int LmServerDBC::Arg1(int index) const
{
    return servers_[index].arg1;
}

int LmServerDBC::Arg2(int index) const
{
    return servers_[index].arg2;
}

bool LmServerDBC::AllowPlayers(int index) const
{
    return servers_[index].allow_players;
}

unsigned long LmServerDBC::LevelServerIP(lyra_id_t levelid) const
{
    int index = FindLevelServer(levelid);
    return (index != -1) ? HostIPAddr(index) : 0;
}

int LmServerDBC::LevelServerPort(lyra_id_t levelid) const
{
    int index = FindLevelServer(levelid);
    return (index != -1) ? Arg1(index) : 0;
}

unsigned long LmServerDBC::DatabaseServerIP() const
{
    int index = FindDatabaseServer();
    return (index != -1) ? HostIPAddr(index) : 0;
}

int LmServerDBC::DatabaseServerPort() const
{
    int index = FindDatabaseServer();
    return (index != -1) ? Arg1(index) : 0;
}

const TCHAR* LmServerDBC::DatabaseHost() const
{
    return db_host_;
}

const TCHAR* LmServerDBC::DatabaseAdminEmail() const
{
    return db_admin_email_;
}

const TCHAR* LmServerDBC::DatabaseReturnEmail() const
{
    return db_return_email_;
}

int LmServerDBC::DatabasePort() const
{
    return db_port_;
}

const TCHAR* LmServerDBC::ServerDBPassword() const
{
    return sdb_passwd_;
}

const TCHAR* LmServerDBC::ItemDBPassword() const
{
    return idb_passwd_;
}

const TCHAR* LmServerDBC::PlayerDBPassword() const
{
    return pdb_passwd_;
}

const TCHAR* LmServerDBC::GuildDBPassword() const
{
    return gdb_passwd_;
}

const TCHAR* LmServerDBC::LevelDBPassword() const
{
    return ldb_passwd_;
}

const TCHAR* LmServerDBC::BillingDBPassword() const
{
    return bdb_passwd_;
}

long LmServerDBC::LastSQLCode() const
{
    return last_sql_code_;
}

void LmServerDBC::SetLog(LmLog* log)
{
    log_ = log;
}

LmLog* LmServerDBC::Log() const
{
    return log_;
}

long LmServerDBC::LastCallTime() const
{
    return last_ms_;
}

long LmServerDBC::TotalCallTime() const
{
    return num_ms_;
}

long LmServerDBC::TotalSQLTime() const
{
    return sql_ms_;
}

const TCHAR* LmServerDBC::ServerDBUsername() const
{
    return _T("ul_server");;
}

const TCHAR* LmServerDBC::ItemDBUsername() const
{
    return _T("ul_item");
}

const TCHAR* LmServerDBC::PlayerDBUsername() const
{
    return _T("ul_player");
}

const TCHAR* LmServerDBC::GuildDBUsername() const
{
    return _T("ul_guild");
}

const TCHAR* LmServerDBC::LevelDBUsername() const
{
    return _T("ul_level");
}

const TCHAR* LmServerDBC::BillingDBUsername() const
{
